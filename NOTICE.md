...
- [Solizardking/zk-clawd-primitives](https://github.com/Solizardking/zk-clawd-primitives) — `zk-primitives`
- [Solizardking/solana-clawd](https://github.com/Solizardking/solana-clawd) — wallet, router, TUI upstream, constitution
- [Solizardking/agents](https://github.com/Solizardking/agents) — character JSON
